...
/* 
 *  This program will cutoff reads that has minimal productQ below a threshold (between 0 to 100).
 *  It takes the result of MinimalProductQ as its input, and produces fasta format output.
 *  
 *  Usage:  PQFilter [result of MinimalProductQ] [output (fasta)] [threshold]
 */
...
public class PQFilter {
	...
	public static class Map extends Mapper<LongWritable, Text, Text, LongWritable> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			if (Integer.parseInt(lineArray[2]) > threshold) {
				/* convert result into fasta format */
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = new Job(conf, "PQFilter");
		job.setJarByClass(PQFilter.class);
